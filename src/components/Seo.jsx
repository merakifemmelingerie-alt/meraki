...
const DEFAULT_TITLE = 'Meraki Femme - Moda Íntima'
const DEFAULT_DESCRIPTION = 'Meraki Femme - Lingerie e Moda Íntima. Conheça nossas coleções exclusivas de conjuntos, camisolas, fantasias e acessórios.'
