                        ...
                        <>
                            ...
                            <div className="space-y-6">
                                {cart.filter(item => item && item.id).map((item) => (
                                    <div key={`${item.id}-${item.size}-${item.color || ''}-${item.customText || ''}-${item.isKit ? 'kit' : 'norm'}-${item.kitName || ''}`} className="flex gap-4 pb-6 border-b border-gray-100 last:border-0">
                                        {/* Thumbnail */}
                            ...
                            <div className="bg-[#FAF9F5] p-4 rounded-2xl border border-gray-200/80 space-y-3 mt-4">
