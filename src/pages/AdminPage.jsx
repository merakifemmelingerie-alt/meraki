...
export default function AdminPage() {
    ...
    const menuItems = [
        ...
        { id: 'wishlist_analytics', label: '❤️ Desejos Inteligente', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
        { id: 'product_requests', label: '🛍️ Produtos Solicitados', icon: 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z' },
